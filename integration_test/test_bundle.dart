...
import 'bookmarked_users_tab_it_test.dart' as bookmarked_users_tab_it_test;
import 'home_view_it_test.dart' as home_view_it_test;
import 'patrol_app_test.dart' as patrol_app_test;
import 'user_reputation_view_it_test.dart' as user_reputation_view_it_test;
import 'users_tab_it_test.dart' as users_tab_it_test;
...
Future<void> main() async {
  ...
  group('bookmarked_users_tab_it_test', bookmarked_users_tab_it_test.main);
  group('home_view_it_test', home_view_it_test.main);
  group('patrol_app_test', patrol_app_test.main);
  group('user_reputation_view_it_test', user_reputation_view_it_test.main);
  group('users_tab_it_test', users_tab_it_test.main);
