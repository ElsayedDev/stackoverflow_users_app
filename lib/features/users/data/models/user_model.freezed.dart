...
class _$UserModelImpl implements _UserModel {
  const _$UserModelImpl(
      ...
      this.location,
      @JsonKey(name: 'badge_counts') required this.badgeCounts});
  ...
  @override
  String toString() {
    return 'UserModel(accountId: $accountId, userId: $userId, displayName: $displayName, profileImage: $profileImage, reputation: $reputation, location: $location, badgeCounts: $badgeCounts)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, accountId, userId, displayName,
      profileImage, reputation, location, badgeCounts);
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      final String? location,
      @JsonKey(name: 'badge_counts')
      required final BadgeCountsModel badgeCounts}) = _$UserModelImpl;
