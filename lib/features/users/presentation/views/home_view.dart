...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      BlocSelector<HomeCubit, HomeState, HomeFilterOption>(
        ...
        builder: (context, filterOption) => Scaffold(
          ...
          // instead of PageView to optimize view building and state management
          body: IndexedStack(
            index: _getCurrentIndex(filterOption),
            children: [
              UsersTab(
  ...
  int _getCurrentIndex(HomeFilterOption option) => switch (option) {
        HomeFilterOption.all => 0,
        HomeFilterOption.bookmarked => 1
      };
}
